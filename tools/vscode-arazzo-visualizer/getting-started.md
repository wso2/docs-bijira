...
```
"Create a sample Arazzo file named toolshop.arazzo.yaml with 3 steps using the Toolshop OpenAPI specification below to list all products and create a cart: https://api.practicesoftwaretesting.com/docs"
```
...
![Execution Demo](./images/v3_execution_demo.gif)

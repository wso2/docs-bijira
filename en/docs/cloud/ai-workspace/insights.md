...
| Metric | Description |
|--------|-------------|
| **Total Requests** | The total number of requests processed through your LLM Providers and Proxies. |
...
- **Application activity** — Analyze usage for mapped [GenAI Applications](genai-applications.md).
